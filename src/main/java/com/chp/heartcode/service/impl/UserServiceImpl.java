...
import com.chp.heartcode.model.enums.UserRoleEnum;
...
import com.chp.heartcode.mapper.UserMapper;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    @Override
    public LoginUserVO updateMyProfile(UserProfileUpdateRequest userProfileUpdateRequest, User loginUser) {
        ...
        // 仅允许更新安全字段（昵称、头像、简介），不触碰账号、密码、角色
        User updateUser = new User();
        updateUser.setId(loginUser.getId());
        updateUser.setUserName(userName);
        updateUser.setUserAvatar(userProfileUpdateRequest.getUserAvatar());
        updateUser.setUserProfile(userProfileUpdateRequest.getUserProfile());
        ...
        return this.getLoginUserVO(newUser);
    }
}
