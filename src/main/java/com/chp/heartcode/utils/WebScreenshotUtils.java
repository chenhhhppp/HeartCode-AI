...
/**
 * @Author: CHP
 * @Description: 网页截图工具类 —— 基于 Selenium + Chrome 无头模式
 */
@Slf4j
public class WebScreenshotUtils {
    ...
    private static void compressImage(String originalImagePath, String compressedImagePath) {
        ...
        try {
            ...
            String formatName = compressedImagePath.toLowerCase().endsWith(".png") ? "png" : "jpg";
            ImageIO.write(originalImage, formatName, compressedFile);
        } catch (Exception e) {
